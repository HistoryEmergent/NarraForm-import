-- First, update any existing categories that don't match our new constraint
UPDATE prompt_templates 
SET category = 'custom' 
WHERE category NOT IN ('novel-to-script', 'screenplay-to-script', 'shot-description', 'summary-generation', 'project-prompt', 'reports-generation', 'custom');
...
-- Now add the category constraint
